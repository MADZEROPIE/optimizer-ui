...
inline bool operator<(const OptimizerTrialPoint& t1, const OptimizerTrialPoint& t2) {
    return t1.x < t2.x;
}
...
struct OptimaizerInterval {
    ...
    OptimaizerInterval(OptimizerTrialPoint _left, OptimizerTrialPoint _right, double _rank, double _localM) {
        left = _left;
        right = _right;
        rank = _rank;
        localM = _localM;
...
struct OptimizerNestedTrialPoint {  // Unconstrained
    ...
    OptimizerNestedTrialPoint(int dim) {
        x.resize(dim);
    }
...
struct OptimaizerNestedInterval {
    ...
    OptimaizerNestedInterval(OptimizerNestedTrialPoint _left, OptimizerNestedTrialPoint _right, double _rank,
                             double _localM) {
        left = _left;
        right = _right;
        rank = _rank;
