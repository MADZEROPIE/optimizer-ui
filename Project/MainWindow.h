...
#pragma region Windows Form Designer generated code
    void InitializeComponent(void)
    {
      ...
      title9->Text = L"Operating characteristics";
      ...
      this->stopCheckBox->Size = System::Drawing::Size(166, 17);
      ...
      this->saveOPToolStripMenuItem->Size = System::Drawing::Size(297, 22);
      ...
      this->savePointsToolStripMenuItem->Size = System::Drawing::Size(297, 22);
      ...
      this->saveOPChartToolStripMenuItem->ShortcutKeys = static_cast<System::Windows::Forms::Keys>(((System::Windows::Forms::Keys::Control | System::Windows::Forms::Keys::Alt)
        | System::Windows::Forms::Keys::S));
      this->saveOPChartToolStripMenuItem->Size = System::Drawing::Size(297, 22);
      ...
      this->graphSettingsToolStripMenuItem->Size = System::Drawing::Size(261, 22);
      ...
      this->TaskGeneratorSettingsToolStripMenuItem->Size = System::Drawing::Size(258, 22);
      ...
      this->algSettingsToolStripMenuItem->Size = System::Drawing::Size(258, 22);
...
#pragma endregion
  ...
  private: void DrawIsolines(int task_num, OptimizerSearchSequence* points)
  {
    ...
    float  fpi = 1, step, zlev, x_left, y_min;
    double arg[2];
    String^ taskName;
    ...
    for (i = 0; i < n; i++)
    {
      xray[i] = (float)(i * step + x_left);
      yray[i] = (float)(i * step + y_min);
    }
    for (i = 0; i < n; i++)
      for (j = 0; j < n; j++)
      {
    ...
    dislin::graf(x_left, x_left + fpi, x_left, fpi / 4, y_min, y_min + fpi, y_min, fpi / 4);
  ...
  private: System::Void solveSingleTaskBackgroundWorker_DoWork(System::Object^  sender, System::ComponentModel::DoWorkEventArgs^  e) {
    ...
    FunctionWrapperCommon *targetFunction;
    SharedVector leftBound, rightBound;
    double *x, err_val, err_xy, *y = new double[mTaskGeneratorSettings.GKLSDimention];
